...
function createParticule(e, t) {
    var a = {};
    return a.x = e, a.y = t, a.color = colors[anime.random(0, colors.length - 1)], a.radius = anime.random(8, 7), a.endPos =
...
function createCircle(e, t) {
    var a = {};
    return a.x = e, a.y = t, a.color = "#f2be45", a.radius = 0.01, a.alpha = 0.5, a.lineWidth = 10, a.draw = function () {
...
function animateParticules(e, t) {
    ...
    anime.timeline().add({
        ...
        targets: a,
        radius: anime.random(30, 45),
        lineWidth: 0,
        alpha: {
            value: 0,
            easing: "linear",
            duration: anime.random(1300, 1900)
        },
        duration: anime.random(1000, 1200),
        easing: "easeOutExpo",
        update: renderParticule,
